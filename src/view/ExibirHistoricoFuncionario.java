...
public class ExibirHistoricoFuncionario extends TelaInterna{	
	...
	private List<HistoricoFuncionario> historicosList;
	private JPanel painelSuperior, painelInferior;
	private BorderLayout layout;
	
	public ExibirHistoricoFuncionario(Dimension dimensaoTela, DesktopPrincipal pertenceDesktop) {
		super("Histórico de Funcionários", 1000, 600, true, true, true, dimensaoTela, pertenceDesktop);
	...
	public void editarObjetos(){
		...
		opcoesBuscaComboBox.addItem("Funcionário Alterado");
...
//		painelSuperior.setPreferredSize(new Dimension(980, 50));
	...
	public List<HistoricoFuncionario> getHistoricosList() {
		return historicosList;
	}

	public void setHistoricosList(List<HistoricoFuncionario> historicosList) {
