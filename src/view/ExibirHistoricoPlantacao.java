...
public class ExibirHistoricoPlantacao extends TelaInterna{	
	...
	private List<HistoricoPlantacao> historicosList;
	private JPanel painelSuperior, painelInferior;
	private BorderLayout layout;
	
	public ExibirHistoricoPlantacao(Dimension dimensaoTela, DesktopPrincipal pertenceDesktop) {
		super("Histórico de Plantações", 1000, 600, true, true, true, dimensaoTela, pertenceDesktop);
	...
	public void editarObjetos(){
		...
		opcoesBuscaComboBox.addItem("Cultura Alterada");
...
//		painelSuperior.setPreferredSize(new Dimension(980, 50));
	...
	public List<HistoricoPlantacao> getHistoricosList() {
		return historicosList;
	}

	public void setHistoricosList(List<HistoricoPlantacao> historicosList) {
